...
title: FAQ
description: >-
  Frequently asked questions about Floodgate such as changing prefixes,
  obtaining Bedrock player UUIDs, and using Floodgate with PlaceholderAPI and
  Skript.
crowdin_page_id: 7a0d836f-f6fa-4091-b97c-c60c355b0acd
---
...
<Questions>
    ...
    <Q>
        How do I get placeholders from PlaceholderAPI for Bedrock players?
        <A>
