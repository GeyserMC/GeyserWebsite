...
:::caution
Geyser-Fabric and Geyser-NeoForge run  **only** on a <Versions platform="java"/> Fabric server.   
...
:::info
For Geyser-Fabric: To allow Bedrock Edition players to join your server without needing to log in to a paid Java Edition account, you can use <a href="/wiki/floodgate/setup/">Floodgate</a>.
:::