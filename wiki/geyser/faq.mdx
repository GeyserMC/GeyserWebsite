...
description: Frequently asked questions about Geyser, including how it works, what plugins are incompatible, and more.
---
...
<Questions>
    ...
    <Q>
        ...
        <A>
            This is a Bedrock client issue caused by Bedrock being 32-bit and Java being 64-bit. For more information read [here](https://minecraft.wiki/w/Bedrock_Edition_distance_effects). This can be workaround using an [unofficial extension](https://github.com/oryxel1/GeyserFloatingPoints) by spoofing your position.
        </A>
    </Q>
    <Q>
