...
description: >-
  Frequently asked questions about Geyser, including how it works, what plugins
  are incompatible, and more.
crowdin_page_id: bb14391a-47cb-4d04-bbc0-05c4466272a6
---
...
<Questions>
    ...
    <Q>
        ...
        <A>
            Please see [this page](/wiki/geyser/supported-versions) for detailed information.
        </A>
    </Q>
    <Q>
    ...
    <Q>
        ...
        <A>
            This is a Bedrock client issue caused by Bedrock being 32-bit and Java being 64-bit. For more information read [here](https://minecraft.wiki/w/Bedrock_Edition_distance_effects). This can be worked around using an [unofficial Geyser extension](https://github.com/oryxel1/GeyserFloatingPoints) that spoofs the player position.
        </A>
    </Q>
    <Q>
    ...
    <Q>
        ...
        <A>
            ...
            Alternatively, if you cannot get the above AvatarUrl to work with DiscordSRV, or you'd like to use it with another plugin that does not support texture ids, you can use the [Starlight Skin API.](https://docs.lunareclipse.studio/)
        </A>
    </Q>
    <Q>
...
<Questions>
    ...
    <Q>
        ...
        <A>
            No. They have their own bedrock server tech you can find out more info about [here](https://www.cubecraft.net/threads/behind-the-cube-1-feelin-lucky.264600/).
        </A>
    </Q>
</Questions>
