...
<Questions>
    ...
    <Q>
        ...
        <A>
            GeyserUpdater ([GitHub page](https://github.com/NewAmazingPVP/AutoUpdateGeyser)/[Spigot page](https://www.spigotmc.org/resources/109632/)) is a Spigot/Bungeecord/Velocity plugin option for auto-updating. Please note that this plugin is also unaffiliated and unsupported by Geyser, and users should redirect support for the plugin to its [Discord](https://discord.com/invite/tuVvmawsRX).
        </A>
    </Q>
    <Q>
