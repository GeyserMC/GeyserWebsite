...
<Tabs groupId="custom-item-implementation">
    <TabItem value="json" label="Definitions in the Json format">
    ...
    <TabItem value="api" label="Definitions in the Geyser API">
...
<Tabs groupId="custom-item-implementation">
    ...
    <TabItem value="api" label="Geyser API Example">
        ```java
            TODO
        ```
    </TabItem>
...
<Tabs groupId="custom-item-implementation">
    <TabItem value="json" label="Using components in json mappings">
        TODO
    </TabItem>

    <TabItem value="api" label="Using components with API">
        TODO
    </TabItem>
</Tabs>
</details>
...
<Tabs groupId="custom-item-implementation">
    <TabItem value="json" label="Removing components in json mappings">
    ...
    <TabItem value="api" label="Removing components using the Geyser API">
...
<Tabs groupId="custom-item-implementation">
    <TabItem value="json" label="Using condition predicates in json mappings">
    ...
    <TabItem value="api" label="Using condition predicates with API">
        TODO
    </TabItem>
...
<details>
    <summary>Expand for usage examples.</summary>
    <Tabs groupId="custom-item-implementation">
        <TabItem value="json" label="Using match predicates in json mappings">
        ...
        <TabItem value="api" label="Using match predicates with API">
            TODO
        </TabItem>
...
<details>
    <summary>Expand for usage examples.</summary>
    <Tabs groupId="custom-item-implementation">
        <TabItem value="json" label="Using range dispatch predicates in json mappings">
            TODO
        </TabItem>

        <TabItem value="api" label="Using range dispatch predicates with API">
            TODO
        </TabItem>
