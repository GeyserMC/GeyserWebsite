...
:::info
Since the Geyser API version 2.9.3 (Build #1040 and up), the old custom item format (v1) is deprecated and is no
longer being updated. Old docs can however still be found [here](/wiki/geyser/custom-items-old)
:::
