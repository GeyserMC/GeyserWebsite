...
Example:
```java
event.register(NonVanillaCustomItemDefinition.builder(Identifier.of("hydraulic_test_mod:inauri_ingot"), 99)
    ...
    .component(ItemDataComponents.USE_COOLDOWN, UseCooldown.builder()
        .seconds(999999f)
        .cooldownGroup(Identifier.of("hydraulic_test_mod:inauri_says_fly"))
        .build())
    .build());
```
