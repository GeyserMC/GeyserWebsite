...
- `components`: Java item components that specify item behavior, such as the maximum stack size. See TODO for more information.
- `predicate`: Predicates used to match a specific custom item definition to an item stack. See TODO for more
...
<Tabs>
    <TabItem value="using-json" label="Definitions in the Json format">
    ...
    <TabItem value="using-api" label="Definitions in the Geyser API">
...
<Tabs>
    <TabItem value="json-bedrock-options" label="Json mapping example">
        ```json
            TODO
        ```
    </TabItem>

    <TabItem value="using-api" label="Geyser API Example">
        ```java
            TODO
        ```
    </TabItem>
...
Java Edition allows modifying these for any item stack at runtime. This is, unfortunately,
not a feature Bedrock Edition supports. Therefore, components must be specified in mapping files.
...
Along with the components listed here, default component removal is also possible.

<details>
<summary>Expand for component usage examples</summary>
<Tabs>
    <TabItem value="json-component-examples" label="Using components in json mappings">
        TODO
    </TabItem>

    <TabItem value="api-component-examples" label="Using components with API">
        TODO
    </TabItem>
...
<Tabs>
    <TabItem value="json-removing-component-examples" label="Removing components in json mappings">
    ...
    <TabItem value="api-removing-component-examples" label="Removing components using the Geyser API">
...
<Tabs>
    <TabItem value="json-condition-predicate-examples" label="Using condition predicates in json mappings">
    ...
    <TabItem value="api-condition-predicate-examples" label="Using condition predicates with API">
        TODO
    </TabItem>
...
<details>
    <summary>Expand for usage examples.</summary>
    <Tabs>
        <TabItem value="json-match-predicate-examples" label="Using match predicates in json mappings">
        ...
        <TabItem value="api-match-predicate-examples" label="Using match predicates with API">
            TODO
        </TabItem>
...
<details>
    <summary>Expand for usage examples.</summary>
    <Tabs>
        <TabItem value="json-range-dispatch-predicate-examples" label="Using range dispatch predicates in json mappings">
            TODO
        </TabItem>

        <TabItem value="api-range-dispatch-predicate-examples" label="Using range dispatch predicates with API">
            TODO
        </TabItem>
