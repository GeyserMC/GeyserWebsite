...
custom waypoint mappings automatically. However, automatic tools such as [Rainbow](/wiki/other/rainbow/) are planning
...
<Tabs groupId="custom-waypoint-implementation">
    <TabItem value="json" label="JSON-mappings">
        ...
        > `textures/ui/&lt;namespace&rt;/locator_bar_dot/&lt;path&rt;`
    ...
    <TabItem value="api" label="Geyser API">
        ...
        public void onSessionDefineCustomWaypoints(SessionDefineCustomWaypointsEvent event) {
            ...
            event.register(Identifier.of("geyser:my_second_waypoint"), CustomWaypointStyle.vanillaLike(128, 332)
...
It can then be registered through the `SessionDefineCustomWaypointsEvent` as follows:
